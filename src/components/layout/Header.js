...
export default function Header({ title, subtitle }) {
    return (
        <header className="h-16 flex items-center justify-between px-6 pl-16 lg:pl-6 border-b border-surface-700/50 bg-surface-900/50 backdrop-blur-sm sticky top-0 z-30">
            <div>
